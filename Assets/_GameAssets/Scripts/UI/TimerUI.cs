...
{
    [Header("References")]
    [SerializeField] private RectTransform _timerRotaetableTransform;
    ...
    {
        _rotationTween = _timerRotaetableTransform.DORotate(new Vector3(0f, 0f, -360f), _rotateDuration, RotateMode.FastBeyond360)
